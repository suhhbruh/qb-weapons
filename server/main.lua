...
QBCore.Functions.CreateCallback("weapons:server:RepairWeapon", function(source, cb, RepairPoint, data)
    ...
    local Player = QBCore.Functions.GetPlayer(src)
    local minute = 20 * 500
    local Timeout = math.random(2 * minute, 5 * minute)
...
-- Airsoft Ammo
QBCore.Functions.CreateUseableItem('air_ammo', function(source, item)
    TriggerClientEvent('weapons:client:AddAmmo', source, 'AMMO_AIR', 20, item)
end)
-- AMMO
